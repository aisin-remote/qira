...
class QualityInternal extends Model
{

    use HasFactory;

    // Tentukan nama tabel (jika berbeda dari nama model dalam bentuk jamak)
    protected $table = 'quality_internals';
     ...
     */
     ...
     public function penangananinternal()
    {
        return $this->hasMany(PenangananInternals::class, 'id_quality_internal');
    }


    public function documentQualityInternal()
    {
